...
<!-- Room Section Start -->
              ...
              <form action="action.php" method="post" name="reservation" class="bg-white p-md-5 p-4 mb-5 border">
                <div class="row">
                  ...
                  <div class="col-md-6 form-group">
                    ...
                    <small id="nomerIdentitasHelp" class="form-text text-danger"></small>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6 form-group">
                    <div class="col-md-6 form-group">
                      <input type="button" value="Cancel" id="cancle" class="btn btn-dark text-white py-3 px-5" onclick= "cancel()">
                    </div>
                  </div>
                </div>
              </form>
            ...
            <div class="col-md-5" data-aos="fade-up" data-aos-delay="200">
              <div class="row">
                <div class="col-md-10 ml-auto contact-info">
                  ...
                  <p><span class="d-block">Whats App:</span> <span class="text-black"> (+68)81904397625</span></p>
 ...
 <!-- <script>
  function cancel() {
    // Tambahkan logika di sini untuk apa yang ingin Anda lakukan saat tombol "Cancel" ditekan
    console.log("Cancel button clicked!");
}

// Mengaitkan fungsi cancel dengan tombol "Cancel"
...
<script>
  ...
  <!-- <script>
    function hitungTotal(){
      ...
      if (durasiMenginap > 3) {
        totalBayar *= 0.9; // diskon 10% untuk durasi lebih dari 3 hari
      }
      if (includeBreakfast === "yes") {
        totalBayar += 80000; // tambahan harga includeBreakfast
      }
      var totalBayar = roomPrice * durasiMenginap;
      

      var totalBayarFormatted = formatRupiah(totalBayar, "Rp. ");
      // Tampilkan total bayar di elemen "totalBayar"
      document.getElementById("totalBayar").value = totalBayarFormatted;
    }
